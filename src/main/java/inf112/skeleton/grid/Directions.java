...
public enum Directions {
     ...
     */
    public static final List<Directions> EIGHT_DIRECTIONS = Arrays.asList(EAST, NORTHEAST, NORTH, NORTHWEST, WEST,
            SOUTHWEST, SOUTH, SOUTHEAST);
    /**
     * The eight cardinal and intercardinal directions ({@link #EIGHT_DIRECTIONS}),
     * plus {@link #CENTER}.
     */
    public static final List<Directions> NINE_DIRECTIONS = Arrays.asList(EAST, NORTHEAST, NORTH, NORTHWEST, WEST,
